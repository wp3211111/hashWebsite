(window.webpackJsonp = window.webpackJsonp || []).push([[23], {
    493: function(e, t, n) {
        ...
        var l = function(e) {
            ...
            function i(t, n) {
                ...
                r.l = function() {
                    var e = r.m
                      , t = e.installing;
                    r.i > 0 || !c(t.scriptURL, r.g) || performance.now() > r.v + 6e4 ? (r.p = t,
                    e.removeEventListener("updatefound", r.l)) : (r.P = t,
                    r.h.add(t),
                    r.o.resolve(t)),
                    ++r.i,
                ...
                r.S = function(e) {
                    ...
                    "installed" === o ? r.A = self.setTimeout((function() {
                        "installed" === o && t.waiting === n && r.dispatchEvent(new u(a + "waiting",s))
                    }
                    ), 200) : "activating" === o && (clearTimeout(r.A),
                    i || r.u.resolve(n))
                }
                ,
                r.O = function(e) {
            ...
            t.__proto__ = n;
            var a, f, l = i.prototype;
            return l.register = function(e) {
                ...
                try {
                    ...
                    return function(e, t) {
                        ...
                        return r.j = Boolean(navigator.serviceWorker.controller),
                        r.I = r.M(),
                        v(r.R(), (function(e) {
                            r.m = e,
                            r.I && (r.P = r.I,
                            ...
                            var t = r.m.waiting;
                            return t && c(t.scriptURL, r.g) && (r.P = t,
            ...
            l.update = function() {
                try {
                    return this.m ? h(this.m.update()) : void 0
                } catch (e) {
                    return Promise.reject(e)
                }
            }
            ...
            l.M = function() {
                ...
                return e && c(e.scriptURL, this.g) ? e : void 0
            }
            ,
            l.R = function() {
                try {
            ...
            ,
            t.B = function(e) {
                return this.k.has(e) || this.k.set(e, new Set),
                this.k.get(e)
            }
            ,
            e
        ...
        function h(e, t) {
            if (!t)
                return e && e.then ? e.then(f) : Promise.resolve()
        }
    }
}]);
